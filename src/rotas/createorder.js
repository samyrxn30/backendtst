...
exports.createPEDIDO = exports.dataorder = void 0;
var mil_1 = require("../mildwaare/mil");
var yup = require("yup");
var databasefuc_1 = require("../database/databasefuc");
exports.dataorder = (0, mil_1.MildawareValidationSchema)({
...
var createPEDIDO = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var jsonorder, result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                jsonorder = req.body;
                return [4 /*yield*/, (0, databasefuc_1.createOrder)(jsonorder)];
            case 1:
                result = _a.sent();
